  ...
  return (
    ...
    >
      <div ref={card} className={clsx(styles.heroDemoContainer, 'transformHoverContainer')}>
        <div className={clsx(styles.heroDemoInner, 'd-flex flex-column align-items-center justify-content-center p-4')}>
          ...
          {userStateDetermined ? (
            <div className={clsx(styles.demoContentContainer, 'flex-fill')}>
              {mintStatus !== '' ? (
                <div className={clsx('d-flex flex-column align-items-center justify-content-center pt-4 ')}>
                  {!mintDone && !portalsNftUnavailable ? (
                    <div
                      className={clsx(
                        styles.demoProgressSpinnerContainer,
                        'flex-fill d-flex align-items-center justify-content-center mb-0',
                      )}
                    >
                      <Image
                  ...
                  {!mintDone && portalsNftUnavailable ? (
                    <p className={clsx(styles.demoProgressHeadline, 'mb-0 textCentered')}>Portals NFT Unavailable...</p>
                  ) : null}
                  {!mintDone && !portalsNftUnavailable ? (
                    <p className={clsx(styles.demoProgressHeadline, 'mb-0 textCentered')}>Minting</p>
                  ) : null}
                  {mintDone && !portalsNftUnavailable ? (
                    <p className={clsx(styles.demoProgressHeadline, 'mb-0 textCentered')}>NFT Minted!</p>
                  ) : null}
                ...
                >
                  <div className={clsx('w-100 mt-3 mb-4')}>
                  ...
                  <div className={clsx(styles.demoSubHeadline, 'textCentered')}>
                    {userLoggedIn ? (
                      <div>
                        Access your NFT any time at{' '}
          ...
          <div className={clsx(styles.grainOverlay)} style={{ backgroundImage: 'url(' + grain + ')' }} />
        </div>

        <div className={clsx(styles.demoDisclaimer, 'mt-3 px-4 textCentered')}>
      ...
      <div className={clsx(styles.iconTryItNow, 'spinLoop')}>
        <Image src={iconTryItNow} width={160} height={160} alt="" />
      </div>
      <div className={clsx(styles.imgNftBackground)}>
        <Image src={imgNftBackground} width={281} height={429} alt="" />
      </div>
    </div>
  );
};
